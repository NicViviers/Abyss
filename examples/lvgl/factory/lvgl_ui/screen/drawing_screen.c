...
{
    ui_drawing_screen = lv_obj_create(NULL);
    ...
    // Create a canvas
    lv_obj_t *canvas = lv_canvas_create(ui_drawing_screen);
    ...
    lv_obj_set_style_text_font(label, &lv_font_montserrat_20, 0); // 20-point font
